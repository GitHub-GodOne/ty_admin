...
// 城市详情
export function cityInfo(data: any) {
  return request({
...
// 物流公司列表
export function expressList(data: any) {
  return request({
...
// 物流公司 编辑
export function expressUpdate(data: any) {
  return request({
...
// 新增物流公司
export function expressSave(data: any) {
  return request({
...
// 删除物流公司
export function expressDelete(data: any) {
  return request({
...
// 物流运费模板列表
export function shippingTemplatesList(data: any) {
  return request({
...
// 物流运费模板详情
export function templateDetailApi(data: any) {
  return request({
...
// 物流运费模板包邮
export function shippingFree(data: any) {
  return request({
...
// 物流运费模板不包邮
export function shippingRegion(data: any) {
  return request({
...
// 物流运费模板新增
export function shippingSave(data: any) {
  return request({
...
// 物流运费模板更新
export function shippingUpdate(data: any, id: any) {
  return request({
...
// 物流运费模板删除
export function shippingDetete(data: any) {
  return request({
...
// 物流公司详情
export function expressInfo(data: any) {
  return request({
